...
import type { MembersOnProjects, Project as PrismaProject } from "@prisma/client";
import type {
  Project,
  Todo,
  TodoDataUnordered,
...
export async function getUser(key: "id" | "email", value: string): Promise<User | null>;
export async function getUser(id: User["id"]): Promise<User | null>;

export async function getUser(id: string, value?: string): Promise<User | null> {
  if (value != null) {
...
export async function getUserSecure(key: "id" | "email", value: string): Promise<User | null>;
export async function getUserSecure(id: string, value: never): Promise<User | null>;

export async function getUserSecure(id: string, value?: string): Promise<UserSecure | null> {
  // @ts-ignore
...
export async function getTodosFromList(listId: TodoList["id"]): Promise<Todo[]> {
  return await prisma.todo.findMany({
    where: {
      todoListId: listId
    },
