// import type { UserSecure, Project } from "src/models";
...
// import { getUserProjects } from "src/db.server";
...
export default function DashboardIndex() {
  ...
  // const [projectToDelete, setProjectToDelete] = React.useState<Project["id"] | null>(null);
  ...
  //       <deleteFetcher.Form
  //         hidden
  //         action={projectToDelete ? `projects/${projectToDelete}/delete` : undefined}
